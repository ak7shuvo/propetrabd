    ...
    <footer className="footer">
      <div className="container footer-top">
        <div className="footer-brand">
          <Brand />
          <p>Smarter Stays. Stronger Business.</p>
        </div>
      ...
      <div className="product-body">
        ...
        <div className="dash">
          ...
          <div className="metric-grid">
            <Metric label="Occupancy" value="86%" note="Illustrative" />
          ...
          <div className="dash-lower">
            <div className="room-card">
              ...
              <div className="room-stats">
                <Room label="Occupied" value="89" cls="occupied" />
                <Room label="Available" value="9" cls="available" />
                <Room label="Dirty" value="4" cls="dirty" />
                <Room label="OOS" value="2" cls="oos" />
              </div>
...
export const solutionIcons = [Building, Sun, Key, Home, Calendar];
