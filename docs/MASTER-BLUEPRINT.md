...
## Product preview
Use realistic illustrative data such as occupancy, arrivals, departures, revenue, room status and reservation activity. These are demo values only.
...
## Conversion
Demo fields:
Name, Organization, Property Name, Property Type, Number of Rooms, Email, Phone, Message.

If no backend exists, never pretend a form actually sends data.

## Design
Primary #0F766E, accent #F97316, slate neutrals, Inter/Plus Jakarta Sans. Premium, clean, operational, trustworthy. Avoid excessive gradients, glassmorphism and generic AI/SaaS aesthetics.

## Technical direction
Recommended: Next.js, TypeScript, Tailwind CSS and Lucide icons. Component-based architecture. Exact structure can adapt to the chosen framework version.

## Accessibility
Semantic HTML, keyboard navigation, visible focus, accessible labels/errors, sufficient contrast, meaningful alt text and reduced-motion support.

## SEO
Unique titles/descriptions, Open Graph, semantic headings, canonical strategy and accurate structured data.

## Performance
Optimized assets, minimal unnecessary JavaScript, sensible code splitting, lightweight animation and no unnecessary libraries.
...
## Master principle
Show the product, explain the value, establish trust, and make the next step obvious.
